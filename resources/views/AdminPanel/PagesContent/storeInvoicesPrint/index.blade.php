            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{route('storeInvoicesPrint.index')}}">Invoices</a></li>
                    </ol>
                </div>
                <div class="col-sm-12">
...
{{--                    </form>--}}
                    ...
                    <br>
                    <form method="get" action="{{route('storeInvoicesPrint.index')}}">

                        <div class="row">
                            <div class="row col-4">
                            <div class="form-group col-6">
                                <label class="col-form-label" for="name">Order ID 4U</label>
                                <input type="text" name="Order_ID" @if(app('request')->input('Order_ID'))value="{{app('request')->input('Order_ID')}}" @endif class="form-control" id="Order_ID" placeholder=" Invoice Number">
                            </div>


                            <div class="form-group col-6">
                                <label class="col-form-label" for="phone">Invoice Number 4U</label>
                                <input type="text" name="web_order_number" @if(app('request')->input('web_order_number'))value="{{app('request')->input('web_order_number')}}" @endif class="form-control" id="web_order_number" placeholder="Invoice Number 4U">
                            </div>
                            </div>
                            <div class="form-group col-2">
                                <label class="col-form-label" for="user_name">Invoice Oracle Number </label>
                                <input type="text" name="oracle_invoice_number" @if(app('request')->input('oracle_invoice_number'))value="{{app('request')->input('oracle_invoice_number')}}" @endif class="form-control" id="oracle_invoice_number" placeholder="Invoice Oracle Number">
                            </div>

                            <div class="row col-4">
                                <div class="form-group col-6">
                                    <label class="col-form-label" for="start_date">From Date</label>
                                    <input type="date" name="start_date" @if(app('request')->input('start_date'))value="{{app('request')->input('start_date')}}" @endif class="form-control">
                                </div>
                                <div class="form-group col-6">
                                    <label class="col-form-label " for="end_date">To Date</label>
                                    <input type="date" name="end_date" @if(app('request')->input('end_date'))value="{{app('request')->input('end_date')}}" @endif class="form-control">
                                </div>
                            </div>
