                    ...
                    <div class="card card-primary">
                        ...
                        <form  action="{{route('spinners.update',$currentFreeProduct)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="title_ar">Promo Code</label>
                                    <input type="number" name="promo_value" class="form-control"
                                           placeholder="Enter Value" value="@if(old('promo_value')){{old('promo_value')}}@elseif(isset($currentFreeProduct->promo_value)){{$currentFreeProduct->promo_value}}@endif" required>
                                </div>
