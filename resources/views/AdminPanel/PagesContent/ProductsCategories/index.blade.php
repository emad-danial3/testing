            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{route('productsCategories.mainCategory')}}">Main Category</a></li>
                    </ol>
                </div>
                <div class="col-sm-6">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <h3 class="card-title float-right">
                <a class="btn btn-warning" href="{{route('productsCategories.create')}}">Create New Main Category</a>
            </h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                ...
                <table id="areasTable"  class="table table-bordered table-striped">
                    ...
                    @foreach($productsCategories as $row)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-dark" href="{{route('productsCategories.edit',$row)}}">Edit</a>
                                <a class="btn btn-success" href="{{route('productsCategories.viewGraph',$row)}}">View</a>
