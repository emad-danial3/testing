...
<h3 style='color:rgb(0, 148, 167)'>Congratulation {{$data['parent_full_name']}}</h3>

<p style='color:rgb(0, 148, 167)'> {{$data['child_full_name']}} now joining as a {{$data['child_type']}} member on your Team!</p>
