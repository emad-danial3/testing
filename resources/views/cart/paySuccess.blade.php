                    ...
                    <div class="breadscrumb-contain breadscrumb-order">
                        ...
                        <div class="order-box">
                            ...
                            <div class="order-contain">
                                <h3 class="theme-color">{{trans('website.Payment Success',[],session()->get('locale'))}}</h3>
                                <h5 class="text-content">{{trans('website.Payment Success',[],session()->get('locale'))}}</h5>
                        ...
                        @endif
                          ...
                          @if($orderStatus && $orderStatus == 'UNPAID')
                                <h2>{{trans('website.Order',[],session()->get('locale'))}} {{$orderStatus}}</h2>
                            @endif
