...
{{--<div class="bg-image">--}}
{{--    <img--}}
{{--        src="{{asset('website/test/img/').'/'.$Image->image}}"--}}
...
{{--                    <div class="aboutus">--}}
{{--                        <h2 class="aboutus-title" style="color:#00a1bd!important;"><b>{{ trans('auth.attributes.what_is_nettinhhub') }}</b></h2>--}}
{{--                        <p class="aboutus-text" style="font-size:16px;">{!!$paragraphs[0]->value!!}</span></p>--}}
{{--                      <button onclick="myFunction5()" id="myBtn5" class="btn btn-default" style=" background-color: transparent;border: 0px;color: #047c8e; display: inline-block;text-transform: uppercase;border: 1px solid #047c8e;margin: 14px;"><b>{{ trans('auth.attributes.read_more') }}</b></button>--}}
{{--                    </div>--}}
{{--                </div>--}}

{{--                <div class="col-md-6 col-sm-6 col-xs-12">--}}
{{--                    <div class="feature">--}}
{{--                        <div class="feature-box"style="color:#047c8e;">--}}
{{--                            <div class="clearfix"style="color:#047c8e;">--}}
{{--                                <div class="iconset" style="color:#047c8e;">--}}
{{--                                    <span class="glyphicon glyphicon-cog icon" style="color:#047c8e;"></span>--}}
{{--                                </div>--}}
{{--                                <div class="feature-content">--}}
{{--                                    <h4 style="color:#00a1bd;"><b>{{ trans('auth.attributes.our_value') }}</b></h4>--}}
{{--                                    <p style="color:#00a1bd;font-size:16px;" >{{$paragraphs[1]->value}}</p>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="feature-box">--}}
{{--                            <div class="clearfix">--}}
{{--                                <div class="iconset"style="color:#00a1bd;">--}}
{{--                                    <span class="glyphicon glyphicon-cog icon"style="color:#00a1bd;"></span>--}}
{{--                                </div>--}}
{{--                                <div class="feature-content">--}}
{{--                                    <h4 style="color:#00a1bd;"><b>{{ trans('auth.attributes.our_mission') }}</b></h4>--}}
{{--                                    <p style="color:#00a1bd;font-size:16px;">{{$paragraphs[2]->value}}</p>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="feature-box">--}}
...
{{--                                </div>--}}
{{--                                <div class="feature-content">--}}
{{--                                    <h4 style="color:#00a1bd;"><b>{{ trans('auth.attributes.our_vision') }}</b></h4>--}}
{{--                                    <p style="color:#00a1bd;font-size:16px;"><b>{{$paragraphs[3]->value}}</b></p>--}}
{{--                                    <p style="color:#00a1bd;font-size:16px;"><i class="fas fa-circle fa-xs"></i> {{$paragraphs[4]->value}}   </p>--}}
{{--                                    <p style="color:#00a1bd;font-size:16px;" ><i class="fas fa-circle fa-xs"></i> {{$paragraphs[5]->value}}</p>--}}
{{--                                    <p style="color:#00a1bd;font-size:16px;"><i class="fas fa-circle fa-xs"></i> {{$paragraphs[6]->value}}</p>--}}
{{--                                    <p style="color:#00a1bd;font-size:16px;"><i class="fas fa-circle fa-xs"></i> {{$paragraphs[7]->value}}</p>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
